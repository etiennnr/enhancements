...
2. The testsuites currently have their own specific interface/configuration that they need in order to be executed correctly (see [K8s Update test](https://github.com/gardener/gardener/tree/master/.test-defs/ShootKubernetesUpdateTest.yaml#L14)).
